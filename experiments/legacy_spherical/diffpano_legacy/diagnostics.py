...
from experiments.legacy_spherical.diffpano_legacy.projection import _erp_world_grid, _normalize_fovs, _world_to_erp_grid, extract_views_from_erp_standard
...
def _compute_projection_diagnostics(
    ...
    from experiments.legacy_spherical.diffpano_legacy.fusion import aggregate_overlap_contributions, project_views_to_erp_standard
...
def temporary_save_original_clean_erp_debug(
    ...
    *,
    ...
    from experiments.legacy_spherical.diffpano_legacy.fusion import render_views_to_erp_standard_weighted
